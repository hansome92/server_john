...
import (
	...
	_ "servers_status/app"
	controllers "servers_status/app/controllers"
	tests "servers_status/tests"
)
...
func main() {
	...
	revel.RegisterController((*controllers.ApiServers)(nil),
		[]*revel.MethodType{
			&revel.MethodType{
				Name: "All",
			...
			&revel.MethodType{
				Name: "Action",
				Args: []*revel.MethodArg{ 
					&revel.MethodArg{Name: "method", Type: reflect.TypeOf((*string)(nil)) },
					&revel.MethodArg{Name: "id", Type: reflect.TypeOf((*string)(nil)) },
				},
				RenderArgNames: map[int][]string{ 
				},
